...
public class MainActivity extends Activity {
    ...
    TextView info, infoip, msg, bluetooth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bluetooth=(TextView)findViewById(R.id.tv_bluetooth);
    ...
    private class SocketServerThread extends Thread {
        ...
        static final int SocketServerPORT = 54321;
        int count = 0;
        ...
        public void run() {
            ...
            try {
                ...
                while (true) {
                    ...
                    count++;
                    message += "#" + count + ". " +  messageFromClient + "\n";
    ...
    public void onResume() {
        ...
        BluetoothDevice device = btAdapter.getRemoteDevice("98:D3:31:50:23:93");
